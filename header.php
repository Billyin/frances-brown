		...
		<header id="branding" role="banner">
			...
			<hgroup>
				<div class="header-top">
					<div class="left item">
						<div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="/wp-content/themes/the-bootstrap/img/logo.png"/></a></div>
						<div class="titles">
							<h1 id="site-title">
					...
					<div class="right item">
						<div class="book"><a href="/contact">Book an appointment</a></div>
					</div>
			</hgroup>
