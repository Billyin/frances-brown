...
if ( !function_exists( 'za_sidebars_init' ) ) {
	...
	register_sidebar(
            array(
    		'name'          => __('Location Footer one  Widget', 'webilize'),
    		'id'            => 'location-1',
    ...
    register_sidebar(
            array(
    		'name'          => __('Location Footer two Widget', 'webilize'),
    		'id'            => 'location-2',
    		'before_widget' => '<div id="%1$s" class="widget %2$s">',
    		'after_widget'  => '</div>',
    		'before_title'  => '<h3 class="widget-title"><span>',
    ...
    register_sidebar(
            array(
    		'name'          => __('Location Footer three Widget', 'webilize'),
    		'id'            => 'location-3',
    		'before_widget' => '<div id="%1$s" class="widget %2$s">',
    		'after_widget'  => '</div>',
    		'before_title'  => '<h3 class="widget-title"><span>',
	...
	register_sidebar(
            array(
    		'name'          => __('Social icons Footer Widget', 'webilize'),
    		'id'            => 'social',
    		'before_widget' => '<div id="%1$s" class="widget %2$s">',
    		'after_widget'  => '</div>',
            )
	...
	register_sidebar(
            array(
    		'name'          => __('Copyright Footer Widget', 'webilize'),
    		'id'            => 'copyright',
    		'before_widget' => '<div id="%1$s" class="widget %2$s">',
    		'after_widget'  => '</div>',
    		'before_title'  => '<h3 class="widget-title"><span>',
